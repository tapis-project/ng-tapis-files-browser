...
export interface ReqCreateSystem { 
    name?: string;
    description?: string;
    systemType?: ReqCreateSystem.SystemTypeEnum;
    owner?: string;
    host?: string;
    enabled?: boolean;
    effectiveUserId?: string;
    defaultAccessMethod?: ReqCreateSystem.DefaultAccessMethodEnum;
    accessCredential?: Credential;
    bucketName?: string;
    rootDir?: string;
    transferMethods?: Array<ReqCreateSystem.TransferMethodsEnum>;
    port?: number;
    useProxy?: boolean;
    proxyHost?: string;
    proxyPort?: number;
...
export namespace ReqCreateSystem {
